...
//     <a
//       href="#main-content"
//       className="absolute top-0 left-0 z-50 -translate-y-full px-4 py-2 bg-neutral-900 text-neutral-0 rounded-b-md transition-transform duration-200 focus:translate-y-0 sr-only focus:not-sr-only focus:outline-none focus:ring-4 focus:ring-blue-400"
//     >
