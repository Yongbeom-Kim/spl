...
const NavigationOverlayLinks = ({className}: NavigationOverlayLinksProps) => {
  return (
    <div className={`
      ...
      *:hover:scale-clickable-hover *:active:scale-clickable-active *:focus-visible:scale-clickable-focus
...
export const NavigationOverlay = () => {
  const isNavOpen = useAtomValue(isNavOverlayVisibleAtom)
  ...
  return (
    <div
      ...
      z-30
		`,
        {
          // TODO: ensure accessibility to screenreaders. Else, find a different solution.
