...
const DesktopLandingPageHeader = () => (
  <div className="min-h-0 h-full col-span-full row-[1/1] grid grid-cols-subgrid grid-rows-1 bg-transparent relative">
    <div className="h-full w-full p-2 pl-4">
      <img src="/logo.png" className="h-full max-h-full object-contain block" />
    </div>
    <div className="uppercase col-start-2 col-end-2 flex my-auto p-4 py-0 font-navbar">
      Senpai Learn
    </div>
  </div>
)
...
const DesktopLandingPageContents = () => (
  <>
    <div className="col-[2/2] row-[2/2] p-4 pt-10 w-2/3 flex flex-col gap-12">
      ...
      <div className="text-2xl font-semibold">Check out some of our links (TODO copywriting):</div>
    </div>
