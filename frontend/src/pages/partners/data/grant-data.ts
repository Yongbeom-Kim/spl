...
export const grantData: Grant[] = [
  ...
  {
    period: "2021-2023",
    title: "Supporting Academically Weaker Students by Improving Their Self-Regulation for Online Learning",
  ...
  {
    period: "2018-2020",
    title: "A Frontier in Learning Science Educational Research Across Two Nations – Learning to Learn Better (L2LB)",
    grantNumber: "2018-01-EDU/USPC-NUS"
  },
  {
    period: "2018-2020",
    title: "VIPER: Virtual reality and Innovative Pedagogy in EnRiched environment",
    grantNumber: "2018-02-EDU/USPC-NUS"
  },
  {
    period: "2017-2018",
    title: "DS4TOX: Digital Seeds for Toxicology",
    description: "Innovative pedagogical ways to use videos and virtual reality environments for teaching and learning",
